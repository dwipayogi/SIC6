# Dokumentasi:
# Dashboard Streamlit untuk monitoring lingkungan berbasis AI.
# Semua teks dan komentar menggunakan Bahasa Indonesia.
...
# Menampilkan pesan kesalahan dalam Bahasa Indonesia
